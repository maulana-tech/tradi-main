      ...
      <div className="mx-auto max-w-7xl px-5 py-20 sm:px-10 lg:py-[120px]">
        <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-pretty text-[var(--color-text-secondary)]">The latest intents read directly from the testnet contract.</p>
          </div>
            ...
            {rows.map((row) => (
              <li key={row.id.toString()}>
                <Link
                  ...
                  className="grid min-h-24 items-center gap-5 py-5 transition-colors duration-150 hover:text-[var(--color-primary-text)] active:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus)] sm:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)_auto] sm:px-3 motion-reduce:transition-none"
                >
                  <div>
