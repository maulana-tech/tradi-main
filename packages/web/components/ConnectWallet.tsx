        ...
        <div className="flex flex-col gap-1 p-3">
          {connectors.map((c) => (
            <button
              ...
              disabled={isPending}
              className="flex items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-medium text-[--color-foreground] transition-colors hover:bg-[--color-surface-low] active:scale-[0.98] disabled:opacity-50"
            >
              <span className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-[--color-surface-low]">
                <span className="material-symbols-outlined text-lg text-[--color-text-secondary]">
  ...
  return (
    <>
      <button
        ...
        disabled={isPending}
        className="rounded-lg bg-[--color-primary] px-3 py-1.5 text-xs font-semibold text-[--color-primary-fg] hover:bg-[#1a6b2e]"
      >
