    ...
    <div role="alert" className="rounded-2xl border border-[var(--color-danger)]/40 bg-[var(--color-danger-soft)] p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="mt-2 text-sm leading-6 text-pretty text-[var(--color-text-secondary)]">The {role} has not authorized Tradi to transfer {symbol}. Ask them to authorize, then check again—or choose another counterparty.</p>
