...
export const createIntentTool = {
  ...
  description:
    "Create a new Direct OTC intent. Encrypts sellAmount and minBuyAmount off-chain, submits to PrivateOTC contract on Arbitrum Sepolia. Returns intentId + txHash.",
  inputSchema: {
    type: "object",
    properties: {
