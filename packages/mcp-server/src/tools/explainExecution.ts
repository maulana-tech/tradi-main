...
export const explainExecutionTool = {
  ...
  description:
    "Explain the outcome of a KeeperHub execution. Pass the execution details to get a human-readable summary with next steps. Use this after KeeperHub returns a result.",
  inputSchema: {
    type: "object",
    properties: {
