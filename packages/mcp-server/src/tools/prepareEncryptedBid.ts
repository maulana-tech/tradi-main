...
export const prepareEncryptedBidTool = {
  ...
  description:
    "Encrypt a bid amount and return the encoded calldata for submitBid. The calldata can be passed to KeeperHub execute_contract_call for simulation and execution. Does NOT submit the transaction — use KeeperHub for that.",
  inputSchema: {
    type: "object",
    properties: {
