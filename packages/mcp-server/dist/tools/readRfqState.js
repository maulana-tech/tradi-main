...
const STATUS = ["Open", "Filled", "Cancelled", "Expired", "PendingReveal"];
const MODE = ["Direct", "RFQ"];
export const readRfqStateTool = {
    name: "private_otc_read_rfq_state",
    description: "Read full RFQ state for a given intent: maker, tokens, mode, status, deadline, bid count. Encrypted amounts are NOT decrypted. Use this before making a bid/finalize decision.",
    inputSchema: {
        type: "object",
        properties: {
...
//# sourceMappingURL=readRfqState.js.map