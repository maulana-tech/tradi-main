...
export const getPriceReferenceTool = {
    ...
    description: "Get the reference price for a token pair. Returns a fair-value estimate in quote units per base unit. Use this to decide bid amounts for RFQ auctions.",
    inputSchema: {
        type: "object",
        properties: {
            ...
            content: [
                {
                    ...
                    text: JSON.stringify({
                        ...
                        note: "This is a static testnet reference price. Production should use Uniswap TWAP or Chainlink.",
                    }, null, 2),
                },
            ],
        };
...
//# sourceMappingURL=getPriceReference.js.map