 ...
 */
export function buildCoachReport(events, nowSeconds, windowDays) {
    if (windowDays <= 0) {
...
function formatMessage(tradeCount, counterparties, windowDays) {
    if (tradeCount === 0) {
    ...
    return (`📊 Strategy coach (${windowDays}d window):\n` +
