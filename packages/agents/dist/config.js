...
const privateKey = process.env.AGENT_PRIVATE_KEY && process.env.AGENT_PRIVATE_KEY.trim().length > 0
...
export const env = EnvSchema.parse({
    ...
    PRIVATE_OTC_ADDRESS: process.env.PRIVATE_OTC_ADDRESS ||
    ...
    WRITER_MODE: (process.env.WRITER_MODE ?? "agent"),
});
...
export const PRIVATE_OTC_ADDRESS = env.PRIVATE_OTC_ADDRESS;
